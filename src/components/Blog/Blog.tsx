  ...
  const posts: PostData[] = [
    {
      ...
      priority: 1,
      url: "#",
      src: `${import.meta.env.BASE_URL}assets/recipe-pic2.jpg`,
      alt: "recipe-pic-2",
    },
    {
      id: 2,
      ...
      priority: 2,
      url: "#",
      src: `${import.meta.env.BASE_URL}assets/recipe-pic3.jpg`,
      alt: "recipe-pic3",
    },
    {
      id: 3,
      ...
      priority: 2,
      url: "#",
      src: `${import.meta.env.BASE_URL}assets/recipe-pic-Chilakile-1401.jpg`,
      alt: "recipe-pic4",
    },
  ];
  return (
